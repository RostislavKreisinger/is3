/**
 *  data-autosize-input='{ "space": 2 }'
 *
 *  example <input type="text" value="" placeholder="Autosize" data-autosize-input='{ "space": 2 }' />
 */
...
(function (n) {
    ...
    n.AutosizeInput = i, function (t) {
        var i = "autosize-input", r = ["text", "password", "search", "url", "tel", "email", "number"];
